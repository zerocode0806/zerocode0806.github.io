                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update',$product->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('sku',$product->sku) }}" value="" type="text" class="@error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Sku" name="sku">
                                @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control form-control-lg" placeholder="Chose File" name="image">

                                @if ($product->image != "")
                                    <img class="w-50 my-2" src="{{ asset('uploads/products/'.$product->image) }}">
                                @endif
                            </div>
                            <div class="d-grid">
